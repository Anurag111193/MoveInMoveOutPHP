...
<html>
<div class="divider-left inset-sm-left-50 inset-lg-left-100 inset-lg-right-30 section-shadow-right section-sm-top-50 section-sm-bottom-65 text-sm-left shadow-area-ambient shadow-inverse-sm-none">
<h3>LOGIN</h3>
 
<form  method="POST" action="loginform.php">
<div class="range range-xs-center range-md-justify">
<div class="cell-md-6 cell-lg-6 inset-lg-right-0">
<div class="form-group">
<label for="contact-name" class="form-label">Name</label>
<input id="contact-name" type="text" name="txtUser" data-constraints="@Required" class="form-control">
</div>
</div>
<div class="cell-md-6 cell-lg-6 inset-lg-right-0">
<div class="form-group">
<label for="contact-phone" class="form-label">Password</label>
<input id="contact-phone" type="password" name="txtPassword" data-constraints="@Required" class="form-control">
</div>
</div>
...
<div><br></div>
<div class="text-center text-lg-right offset-top-30 offset-lg-top-55">
<button type="submit" class="btn btn-shadow btn-primary">SIGN IN</button>

</div>

</form>
<form action="final.html">
<button type="submit" class="btn btn-shadow btn-primary"  onclick="window.location.href= 'http://127.0.0.1/New_User/final.html'">SIGN UP</button>
<a href="http://localhost/new_user/fp.php">Forgot Password?</a>
</form>
...
<div class="cell-sm-6">
<div>
<p class="text-big-20 text-white">Call Us Toll Free:</p>
</div>
<div class="offset-top-0">
<h4 class="p font-default text-regular"><span class="icon material-design-ico material-design-phone370 text-primary text-middle"></span><a href="callto:#" class="inset-left-5 reveal-inline-block">+1 (504) 123 2323</a></h4>
</div>
</div>
</div>
</div>
