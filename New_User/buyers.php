...
<div class="container">
	<div class="row">
        ...
        <div class="table-responsive">
              ...
              <table id="mytable" class="table table-bordered"><tr><td>
...
$sql = "SELECT * FROM move_in";
$result = $conn->query($sql);



echo "<table class='table'>";
echo "<tr><td><h6>Location</h6></td><td><h6>Date_of_Joining</h6></td><td><h6>Room_Size</h6></td><td><h6>No_of_rooms</h6></td><td><h6>Room_cost</h6></td><td></td></tr>";
